# downloaded from http://www.uniprot.org/help/programmatic_access#batch_retrieval_of_entries
# TODO: convert this into a Python script and make it run on 10239 (Viruses)
